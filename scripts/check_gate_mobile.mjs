...
console.log(JSON.stringify({ fit, controlClearance, ratioMatch, ...value, started, dashState, comboCheck, mapCheck, growth, settingsScreen, screenshot:output }));
if (!fit || !ratioMatch || dashState === "OK" || comboCheck.combo !== 2 || mapCheck.a.seed===mapCheck.b.seed || mapCheck.b.stage!==2 || mapCheck.a.obstacles<10 || mapCheck.b.hazards<3 || growth.upgrades.attack!==2 || growth.upgrades.speed!==2 || growth.upgrades.defense!==2 || growth.slots!==3 || !value.headerHidden || !value.settingsHidden || !settingsScreen.open || !settingsScreen.exportVisible || !settingsScreen.radarVisible || settingsScreen.loadout!==3 || started.label !== "やり直す") process.exitCode = 1;
