...
def build_source_catalog(now, sources):
    ...
    return {
        ...
        "currentWorkflow": {
            ...
            "changeMethod": "edit cron and push",
        },
        "counts": {
            "active": len(active),
...
def main():
    ...
    SOURCE_CATALOG_OUT.write_text(json.dumps(build_source_catalog(now, sources), ensure_ascii=False, indent=2), encoding="utf-8")
